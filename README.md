...
<div style="background-color: #F5F5DC; padding: 15px; font-family: Georgia, serif;">
  <div style="background-color: #E6F2FF; color: #1a1a1a; padding: 25px; border-radius: 8px; line-height: 1.6; font-size: 16px;">
    ...
    <p>Os livros e documento abaixo em pdf podem ser lidos e estão disponíveis para download/visualização:</p>
    <div style="margin: 15px 0;">
      <a href="Karatê_Didática_Técnicas_Estilo_Definições_e_Maestria_.pdf" target="_blank" style="display: inline-block; padding: 12px 20px; margin: 5px 0; background-color: #004080; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold;">Acessar Documento de Karatê (PDF)</a><br>
      <a href="As Ideologias Associadas a Mário Enrique Antúnez da Rosa- (1).pdf" target="_blank" style="display: inline-block; padding: 12px 20px; margin: 5px 0; background-color: #004080; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold;">Baixar/Visualizar PDF (As Ideologias Associadas)</a>
    </div>

    <p>Análise as perspectivas políticas, laicismo, antiautoritarismo e organização social expressas no trabalho.</p>
    <p>Antúnez da Rosa "Sir Mário Honorário":</p>
